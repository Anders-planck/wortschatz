    ...
    <>
      ...
      >
        ...
        <Animated.View entering={FadeInUp.duration(300)}>
          {prerequisiteReason === "needs_vocabulary" ? (
            <PrerequisiteState
              icon="book.closed"
              title="Servono almeno 3 parole salvate"
              description="Aggiungi un po' di vocabolario prima di generare un testo personalizzato."
            ...
            >
              <View style={{ gap: 4 }}>
                ...
                <Text
                  style={[textStyles.bodyLight, { color: colors.textMuted }]}
                >
